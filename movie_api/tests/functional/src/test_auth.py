...
ADMIN_ACCESS_TOKEN = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..R4gMvg67mIYyph35QWvqLugMO6tKlOFGoxgxqtrfyQvW_uOZaoulsiKgj3H-7rOGWh2kMSG2qYfeEiijprfQzwsgt3CF5D7W7idTucxeptLWoxXFjluOxq4JpCS6RUap9bUMgel6SQg6ZkHa0eRVIW5dEkYwLSt4zk8SToPV5uw83AznEqpglCBH0GX8gvp9RriWmUNwqRypFNU-_4jbjdRtgAGduu7fv-jl2nKcL7Kz8gfjzw0bnl_pfZIeDC7DCoKOzI2hYK4tStpnHmrQE1E5m3RAtbK7vk8ZXZha-dCsyR_OxM1aNkbP1NbYSf7eJj5E9UXMni26hNPBsqXYrA'
USER_ACCESS_TOKEN = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9.eyJmcmVzaCI6ZmFsc2UsImlhdCI6MCwianRpIjoiZDU4ZTZhMjktMTAxMy00YjhjLWI4YzYtMjZiM2JhM2VlZDQyIiwibmJmIjowLCJ0eXBlIjoiYWNjZXNzIiwic3ViIjoiNzA2NmVmMjctMGQ5NS00MzVjLTg4MGYtNWZiYTQzOWFlZDczIiwiZXhwIjo5OTk5OTk5OTk5LCJyb2xlcyI6W10sImRldmljZSI6InRlc3R1c2VyIn0.htv18jEGkXbA5RDdfg8ujrqHaU0IlnBjtk02I0_kKCDVVsYC0FZBA0zOZQYpcdZLYj-fbpGfRExdRN3aLJiFCvoGsGYDTeLF_JzSRvlwoyhpb37bX7UbBjsqGHA_YyzylftEMToAWb2ZNMY44cP7FSirgXhqX8U0hlc7fUSDKvYXXnWEsm_CqTqDhHhMXX_WG_vrROckFn7LvZDrYFDMxVtTiSmOhHgQ5CePxuQPfMpZKl8DeDikwL3mZAsw79UlzOCXlPrGgHW04byzWZdMtI85lid0c4auGyvJP_KMW9xqwHfq5fQirvBae4hQP3LUK85bXw1E622b_ouJtOR1aQ'
...
@pytest.mark.asyncio
async def test_unauth_get_only_unsuspicious(make_get_request, films):
    expected_films = [film for film in films if not film["suspicious"]]
...
async def test_auth_get_all_movies(make_get_request, films):
    ...
    assert film_response.status == 200
    assert expected_films == pydantic.parse_obj_as(list[FilmShort], film_response.body)
...
@pytest.mark.asyncio
async def test_unauth_get_suspicious_movie_failure(make_get_request, films):
    film_response = await make_get_request(f'{API_URL}fff4777b-7fe5-4be9-a6ea-6acb75b96fb0')
    assert film_response.status == 404


@pytest.mark.asyncio
async def test_auth_get_suspicious_movie_success(make_get_request, films):
